...
def all_plotter(dt,gb,k,lg,ld,r,s):
    ...
    if dt:
        ax[0].scatter(dtree['COMPONENT-NO.'], dtree['% ACCURACY'], alpha=0.5)
        ax[1].plot(dtree['COMPONENT-NO.'], dtree['% ACCURACY'], alpha=0.5)
    if gb:
        ax[0].scatter(gnb['COMPONENT-NO.'], gnb['% ACCURACY'], alpha=0.5)
        ax[1].plot(gnb['COMPONENT-NO.'], gnb['% ACCURACY'], alpha=0.5)
    if k:
        ax[0].scatter(kn['COMPONENT-NO.'], kn['% ACCURACY'], alpha=0.5)
        ax[1].plot(kn['COMPONENT-NO.'], kn['% ACCURACY'], alpha=0.5)
    if lg:
        ax[0].scatter(log['COMPONENT-NO.'], log['% ACCURACY'], alpha=0.5)
        ax[1].plot(log['COMPONENT-NO.'], log['% ACCURACY'], alpha=0.5)
    if ld:
        ax[0].scatter(lda['COMPONENT-NO.'], lda['% ACCURACY'], alpha=0.5)
        ax[1].plot(lda['COMPONENT-NO.'], lda['% ACCURACY'], alpha=0.5)
    if r:
        ax[0].scatter(rf['COMPONENT-NO.'], rf['% ACCURACY'],alpha=0.5)
        ax[1].plot(rf['COMPONENT-NO.'], rf['% ACCURACY'],alpha=0.5)
    if s:
        ax[0].scatter(sv['COMPONENT-NO.'], sv['% ACCURACY'], alpha=0.5)
